...
int main() {
    ...
    *numberP = 15;
    printf("Valor da variável number Mmodificado: %d\n",number);
    printf("Incremento da variavel ponteiro\n");
    numberP++;
    printf("Valor da variável numberP incrementada: %p\n", numberP);
    printf("Valor no endereço apontado: %d\n", *numberP);
    printf("criação de uma variavel *pi dinamicamente\n");
    float *pi = (float *) malloc(sizeof(float));
    printf("Valor da variável pi: %p\n", pi);
    *pi=3.1415;
    printf("Valor no endereço apontado: %f\n", *pi);
    free(pi);
    printf("liberando a variavel pi com a função free\n");
    printf("Valor da variável pi: %p\n", pi);
